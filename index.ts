import Resp from './src/response';
import MapExapander from './src/mapExpander';

const mapExapander = new MapExapander();
...
export default class ApiFactory {
  ...
  public setAuthorizer(authorizerFunc: Function) {
  ...
  public head(route: string, p0: Function, p1: Function = null) { this.method('HEAD', route, p0, p1); }
  public get(route: string, p0: Function, p1: Function = null) { this.method('GET', route, p0, p1); }
  public post(route: string, p0: Function, p1: Function = null) { this.method('POST', route, p0, p1); }
  public put(route: string, p0: Function, p1: Function = null) { this.method('PUT', route, p0, p1); }
  public patch(route: string, p0: Function, p1: Function = null) { this.method('PATCH', route, p0, p1); }
  public delete(route: string, p0: Function, p1: Function = null) { this.method('DELETE', route, p0, p1); }
